<x-layoutLR title="Blog - Login" titleName='Login'>
    <form method="POST" action="{{ route('user.login_action') }}">
        ...
        <x-forms.text-input type="email" name="email" label="Email" placeholder="Digite seu email" />

        <x-forms.text-input type="password" name="password" label="Senha" placeholder="Digiete sua senha" />
